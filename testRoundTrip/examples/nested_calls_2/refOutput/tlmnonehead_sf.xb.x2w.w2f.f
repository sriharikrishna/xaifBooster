...
C$OPENAD XXX Template ad_template.f
      ...
      CALL setderiv(__deriv__(OpenAD_Symbol_22), __deriv__(X(4)))
      CALL setderiv(__deriv__(OpenAD_Symbol_20), __deriv__(X(3)))
...
C$OPENAD XXX Template ad_template.f
      ...
      CALL sax(OpenAD_Symbol_23, __deriv__(A), __deriv__(C))
      CALL saxpy(OpenAD_Symbol_24, __deriv__(A), __deriv__(C))
      CALL saxpy(OpenAD_Symbol_25, __deriv__(B), __deriv__(C))
      END SUBROUTINE
...
C$OPENAD XXX Template ad_template.f
      ...
      CALL setderiv(__deriv__(OpenAD_Symbol_27), __deriv__(A))
      CALL sax(OpenAD_Symbol_26, __deriv__(OpenAD_Symbol_27), __deriv__
     > (A))
      CALL saxpy(OpenAD_Symbol_28, __deriv__(OpenAD_Symbol_27),
     >  __deriv__(A))
      END SUBROUTINE
