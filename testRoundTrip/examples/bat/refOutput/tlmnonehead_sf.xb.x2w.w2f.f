...
C$OPENAD XXX Template ad_template.f
     ...
     >  OpenAD_Symbol_12)
      CALL sax(OpenAD_Symbol_21, __deriv__(X(1)), __deriv__(Y(1)))
      CALL sax(OpenAD_Symbol_22, __deriv__(X(1)), __deriv__(Y(2)))
      CALL sax(OpenAD_Symbol_23, __deriv__(X(1)), __deriv__(Y(3)))
      CALL sax(OpenAD_Symbol_24, __deriv__(X(1)), __deriv__(Y(4)))
      CALL saxpy(OpenAD_Symbol_25, __deriv__(X(2)), __deriv__(Y(1)))
      CALL saxpy(OpenAD_Symbol_26, __deriv__(X(2)), __deriv__(Y(2)))
      CALL saxpy(OpenAD_Symbol_27, __deriv__(X(2)), __deriv__(Y(3)))
      CALL saxpy(OpenAD_Symbol_28, __deriv__(X(2)), __deriv__(Y(4)))
      CALL saxpy(OpenAD_Symbol_29, __deriv__(X(3)), __deriv__(Y(1)))
      CALL saxpy(OpenAD_Symbol_30, __deriv__(X(3)), __deriv__(Y(2)))
      CALL saxpy(OpenAD_Symbol_31, __deriv__(X(3)), __deriv__(Y(3)))
      CALL saxpy(OpenAD_Symbol_32, __deriv__(X(3)), __deriv__(Y(4)))
      CALL saxpy(OpenAD_Symbol_33, __deriv__(X(4)), __deriv__(Y(1)))
      CALL saxpy(OpenAD_Symbol_34, __deriv__(X(4)), __deriv__(Y(2)))
      CALL saxpy(OpenAD_Symbol_35, __deriv__(X(4)), __deriv__(Y(3)))
      CALL saxpy(OpenAD_Symbol_36, __deriv__(X(4)), __deriv__(Y(4)))
      END SUBROUTINE
