C ***********************************************************
C Fortran file translated from WHIRL Mon Apr  2 13:21:03 2007
C ***********************************************************
C ***********************************************************
...
C$OPENAD XXX Template ad_template.f
     ...
     > )
        ...
        CALL setderiv(__deriv__(OpenAD_Symbol_137), __deriv__(FLDNOW(1)
     > ))
        CALL setderiv(__deriv__(OpenAD_Symbol_135), __deriv__(FLDNOW(2)
     > ))
        CALL setderiv(__deriv__(OpenAD_Symbol_132), __deriv__(FLDNOW(1)
     > ))
        CALL setderiv(__deriv__(OpenAD_Symbol_130), __deriv__(FLDNOW(3)
     > ))
        CALL setderiv(__deriv__(OpenAD_Symbol_126), __deriv__(FLDNOW(2)
     > ))
        CALL setderiv(__deriv__(OpenAD_Symbol_124), __deriv__(FLDNOW(1)
     > ))
        CALL setderiv(__deriv__(OpenAD_Symbol_121), __deriv__(FLDNOW(3)
     > ))
        CALL setderiv(__deriv__(OpenAD_Symbol_119), __deriv__(FLDNOW(2)
     > ))
        CALL sax(OpenAD_Symbol_118, __deriv__(OpenAD_Symbol_119),
     >  __deriv__(DFLDDT(3)))
        CALL saxpy(OpenAD_Symbol_120, __deriv__(OpenAD_Symbol_121),
     >  __deriv__(DFLDDT(3)))
        CALL sax(OpenAD_Symbol_123, __deriv__(OpenAD_Symbol_124),
     >  __deriv__(DFLDDT(2)))
        CALL saxpy(OpenAD_Symbol_125, __deriv__(OpenAD_Symbol_126),
     >  __deriv__(DFLDDT(2)))
        CALL sax(OpenAD_Symbol_129, __deriv__(OpenAD_Symbol_130),
     >  __deriv__(DFLDDT(1)))
        CALL saxpy(OpenAD_Symbol_131, __deriv__(OpenAD_Symbol_132),
     >  __deriv__(DFLDDT(1)))
        CALL saxpy(OpenAD_Symbol_134, __deriv__(OpenAD_Symbol_135),
     >  __deriv__(DFLDDT(2)))
        CALL saxpy(OpenAD_Symbol_136, __deriv__(OpenAD_Symbol_137),
     >  __deriv__(DFLDDT(1)))
      ELSE
     ...
     > ))
        ...
        CALL setderiv(__deriv__(OpenAD_Symbol_169), __deriv__(FLDNOW(1)
     > ))
        CALL setderiv(__deriv__(OpenAD_Symbol_167), __deriv__(FLDNOW(2)
     > ))
        CALL setderiv(__deriv__(OpenAD_Symbol_164), __deriv__(FLDNOW(1)
     > ))
        CALL setderiv(__deriv__(OpenAD_Symbol_162), __deriv__(FLDNOW(2)
     > ))
        CALL setderiv(__deriv__(OpenAD_Symbol_158), __deriv__(FLDNOW(2)
     > ))
        CALL setderiv(__deriv__(OpenAD_Symbol_156), __deriv__(FLDNOW(3)
     > ))
        CALL setderiv(__deriv__(OpenAD_Symbol_153), __deriv__(FLDNOW(3)
     > ))
        CALL setderiv(__deriv__(OpenAD_Symbol_151), __deriv__(FLDNOW(1)
     > ))
        CALL sax(OpenAD_Symbol_150, __deriv__(OpenAD_Symbol_151),
     >  __deriv__(DFLDDT(3)))
        CALL saxpy(OpenAD_Symbol_152, __deriv__(OpenAD_Symbol_153),
     >  __deriv__(DFLDDT(3)))
        CALL sax(OpenAD_Symbol_155, __deriv__(OpenAD_Symbol_156),
     >  __deriv__(DFLDDT(2)))
        CALL saxpy(OpenAD_Symbol_157, __deriv__(OpenAD_Symbol_158),
     >  __deriv__(DFLDDT(2)))
        CALL sax(OpenAD_Symbol_161, __deriv__(OpenAD_Symbol_162),
     >  __deriv__(DFLDDT(1)))
        CALL saxpy(OpenAD_Symbol_163, __deriv__(OpenAD_Symbol_164),
     >  __deriv__(DFLDDT(1)))
        CALL saxpy(OpenAD_Symbol_166, __deriv__(OpenAD_Symbol_167),
     >  __deriv__(DFLDDT(2)))
        CALL saxpy(OpenAD_Symbol_168, __deriv__(OpenAD_Symbol_169),
     >  __deriv__(DFLDDT(1)))
      ENDIF
      DO L = 1, 3, 1
     ...
     >  OpenAD_Symbol_53)
        ...
        CALL setderiv(__deriv__(OpenAD_Symbol_139), __deriv__(DFLDDT(L)
     > ))
        CALL sax(OpenAD_Symbol_138, __deriv__(OpenAD_Symbol_139),
     >  __deriv__(FLDNEW(L)))
      END DO
      RETURN
      END SUBROUTINE
