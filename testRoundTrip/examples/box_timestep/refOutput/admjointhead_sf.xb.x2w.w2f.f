C ***********************************************************
C Fortran file translated from WHIRL Fri Jul 21 11:32:26 2006
C ***********************************************************
C ***********************************************************
...
C       $OpenAD$ INLINE Saxpy(subst,subst,subst)
     ...
     > OpenAD_Symbol_184))), __deriv__(OpenAD_Symbol_139))
...
C       $OpenAD$ INLINE Saxpy(subst,subst,subst)
        CALL Saxpy(OpenAD_Symbol_176, __deriv__(DFLDDT(1)), __deriv__(
     > OpenAD_Symbol_137))
C       $OpenAD$ INLINE Pop(subst)
        CALL Pop(OpenAD_Symbol_177)
C       $OpenAD$ INLINE Saxpy(subst,subst,subst)
        CALL Saxpy(OpenAD_Symbol_177, __deriv__(DFLDDT(2)), __deriv__(
     > OpenAD_Symbol_135))
C       $OpenAD$ INLINE Pop(subst)
        CALL Pop(OpenAD_Symbol_178)
C       $OpenAD$ INLINE Saxpy(subst,subst,subst)
        CALL Saxpy(OpenAD_Symbol_178, __deriv__(DFLDDT(1)), __deriv__(
     > OpenAD_Symbol_132))
C       $OpenAD$ INLINE Pop(subst)
        CALL Pop(OpenAD_Symbol_179)
C       $OpenAD$ INLINE Saxpy(subst,subst,subst)
        CALL Saxpy(OpenAD_Symbol_179, __deriv__(DFLDDT(1)), __deriv__(
     > OpenAD_Symbol_130))
C       $OpenAD$ INLINE ZeroDeriv(subst)
...
C       $OpenAD$ INLINE Saxpy(subst,subst,subst)
        CALL Saxpy(OpenAD_Symbol_180, __deriv__(DFLDDT(2)), __deriv__(
     > OpenAD_Symbol_126))
C       $OpenAD$ INLINE Pop(subst)
        CALL Pop(OpenAD_Symbol_181)
C       $OpenAD$ INLINE Saxpy(subst,subst,subst)
        CALL Saxpy(OpenAD_Symbol_181, __deriv__(DFLDDT(2)), __deriv__(
     > OpenAD_Symbol_124))
C       $OpenAD$ INLINE ZeroDeriv(subst)
...
C       $OpenAD$ INLINE Saxpy(subst,subst,subst)
        CALL Saxpy(OpenAD_Symbol_182, __deriv__(DFLDDT(3)), __deriv__(
     > OpenAD_Symbol_121))
C       $OpenAD$ INLINE Pop(subst)
        CALL Pop(OpenAD_Symbol_183)
C       $OpenAD$ INLINE Saxpy(subst,subst,subst)
        CALL Saxpy(OpenAD_Symbol_183, __deriv__(DFLDDT(3)), __deriv__(
     > OpenAD_Symbol_119))
C       $OpenAD$ INLINE ZeroDeriv(subst)
...
C       $OpenAD$ INLINE Saxpy(subst,subst,subst)
        CALL Saxpy(OpenAD_Symbol_187, __deriv__(DFLDDT(1)), __deriv__(
     > OpenAD_Symbol_169))
C       $OpenAD$ INLINE Pop(subst)
        CALL Pop(OpenAD_Symbol_188)
C       $OpenAD$ INLINE Saxpy(subst,subst,subst)
        CALL Saxpy(OpenAD_Symbol_188, __deriv__(DFLDDT(2)), __deriv__(
     > OpenAD_Symbol_167))
C       $OpenAD$ INLINE Pop(subst)
        CALL Pop(OpenAD_Symbol_189)
C       $OpenAD$ INLINE Saxpy(subst,subst,subst)
        CALL Saxpy(OpenAD_Symbol_189, __deriv__(DFLDDT(1)), __deriv__(
     > OpenAD_Symbol_164))
C       $OpenAD$ INLINE Pop(subst)
        CALL Pop(OpenAD_Symbol_190)
C       $OpenAD$ INLINE Saxpy(subst,subst,subst)
        CALL Saxpy(OpenAD_Symbol_190, __deriv__(DFLDDT(1)), __deriv__(
     > OpenAD_Symbol_162))
C       $OpenAD$ INLINE ZeroDeriv(subst)
        CALL ZeroDeriv(__deriv__(DFLDDT(1)))
C       $OpenAD$ INLINE Pop(subst)
...
C       $OpenAD$ INLINE Saxpy(subst,subst,subst)
        CALL Saxpy(OpenAD_Symbol_191, __deriv__(DFLDDT(2)), __deriv__(
     > OpenAD_Symbol_158))
C       $OpenAD$ INLINE Pop(subst)
        CALL Pop(OpenAD_Symbol_192)
C       $OpenAD$ INLINE Saxpy(subst,subst,subst)
        CALL Saxpy(OpenAD_Symbol_192, __deriv__(DFLDDT(2)), __deriv__(
     > OpenAD_Symbol_156))
C       $OpenAD$ INLINE ZeroDeriv(subst)
        CALL ZeroDeriv(__deriv__(DFLDDT(2)))
C       $OpenAD$ INLINE Pop(subst)
...
C       $OpenAD$ INLINE Saxpy(subst,subst,subst)
        CALL Saxpy(OpenAD_Symbol_193, __deriv__(DFLDDT(3)), __deriv__(
     > OpenAD_Symbol_153))
C       $OpenAD$ INLINE Pop(subst)
        CALL Pop(OpenAD_Symbol_194)
C       $OpenAD$ INLINE Saxpy(subst,subst,subst)
        CALL Saxpy(OpenAD_Symbol_194, __deriv__(DFLDDT(3)), __deriv__(
     > OpenAD_Symbol_151))
C       $OpenAD$ INLINE ZeroDeriv(subst)
        CALL ZeroDeriv(__deriv__(DFLDDT(3)))
C       $OpenAD$ INLINE IncDeriv(subst,subst)
...
C     $OpenAD$ INLINE cp_tsarg_restore_real_vector(subst)
      CALL cp_tsarg_restore_real_vector(FLDOLD)
...
C     $OpenAD$ INLINE cp_tsarg_restore_real_scalar(subst)
      CALL cp_tsarg_restore_real_scalar(UVELLOC)
C     $OpenAD$ INLINE cp_tsarg_restore_real_scalar(subst)
