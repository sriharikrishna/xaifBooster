C ***********************************************************
C Fortran file translated from WHIRL Mon Jul 23 11:08:22 2007
C ***********************************************************
C ***********************************************************
...
C$OPENAD XXX Template ad_template.f
      OpenAD_Symbol_3 = (__value__(X) * 2.0D00)
...
C     $OpenAD$ INLINE pop_i(subst)
      CALL pop_i(L)
      CALL foo(__deriv__(OpenAD_Symbol_9), __deriv__(Q(L)))
C     $OpenAD$ INLINE CondIncZeroDeriv(subst,subst)
      CALL CondIncZeroDeriv(__deriv__(Y), __deriv__(OpenAD_Symbol_7))
C     $OpenAD$ INLINE IncDeriv(subst,subst)
      CALL IncDeriv(__deriv__(OpenAD_Symbol_7), __deriv__(Q(1)))
C     $OpenAD$ INLINE ZeroDeriv(subst)
      CALL ZeroDeriv(__deriv__(OpenAD_Symbol_7))
C     $OpenAD$ INLINE CondIncZeroDeriv(subst,subst)
      CALL CondIncZeroDeriv(__deriv__(Q(1)), __deriv__(OpenAD_Symbol_6)
     > )
C     $OpenAD$ INLINE IncDeriv(subst,subst)
      CALL IncDeriv(__deriv__(OpenAD_Symbol_6), __deriv__(Y))
C     $OpenAD$ INLINE ZeroDeriv(subst)
