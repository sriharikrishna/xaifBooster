...
C$OPENAD XXX Template ad_template.f
     ...
     >  OpenAD_Symbol_171)
          ...
          CALL sax(OpenAD_Symbol_195, __deriv__(PTL), __deriv__(FVEC(K)
     > ))
          CALL saxpy(OpenAD_Symbol_197, __deriv__(PTR), __deriv__(FVEC(
     > K)))
          CALL saxpy(OpenAD_Symbol_200, __deriv__(P), __deriv__(FVEC(K)
     > ))
          CALL saxpy(OpenAD_Symbol_202, __deriv__(PTT), __deriv__(FVEC(
     > K)))
          CALL saxpy(OpenAD_Symbol_205, __deriv__(PBR), __deriv__(FVEC(
     > K)))
          CALL saxpy(OpenAD_Symbol_207, __deriv__(PTR), __deriv__(FVEC(
     > K)))
          CALL saxpy(OpenAD_Symbol_210, __deriv__(P), __deriv__(FVEC(K)
     > ))
          CALL saxpy(OpenAD_Symbol_212, __deriv__(PRR), __deriv__(FVEC(
     > K)))
          CALL saxpy(OpenAD_Symbol_215, __deriv__(PL), __deriv__(FVEC(K
     > )))
          CALL saxpy(OpenAD_Symbol_217, __deriv__(PR), __deriv__(FVEC(K
     > )))
          CALL saxpy(OpenAD_Symbol_220, __deriv__(PB), __deriv__(FVEC(K
     > )))
          CALL saxpy(OpenAD_Symbol_222, __deriv__(PT), __deriv__(FVEC(K
     > )))
          CALL saxpy(OpenAD_Symbol_225, __deriv__(PLL), __deriv__(FVEC(
     > K)))
          CALL saxpy(OpenAD_Symbol_227, __deriv__(P), __deriv__(FVEC(K)
     > ))
          CALL saxpy(OpenAD_Symbol_230, __deriv__(PBL), __deriv__(FVEC(
     > K)))
          CALL saxpy(OpenAD_Symbol_232, __deriv__(PTL), __deriv__(FVEC(
     > K)))
          CALL saxpy(OpenAD_Symbol_235, __deriv__(PBL), __deriv__(FVEC(
     > K)))
          CALL saxpy(OpenAD_Symbol_237, __deriv__(PBR), __deriv__(FVEC(
     > K)))
          CALL saxpy(OpenAD_Symbol_240, __deriv__(PBB), __deriv__(FVEC(
     > K)))
          CALL saxpy(OpenAD_Symbol_242, __deriv__(P), __deriv__(FVEC(K)
     > ))
          CALL saxpy(OpenAD_Symbol_245, __deriv__(PR), __deriv__(FVEC(K
     > )))
          CALL saxpy(OpenAD_Symbol_246, __deriv__(PL), __deriv__(FVEC(K
     > )))
          CALL saxpy(OpenAD_Symbol_248, __deriv__(PT), __deriv__(FVEC(K
     > )))
          CALL saxpy(OpenAD_Symbol_249, __deriv__(PB), __deriv__(FVEC(K
     > )))
          CALL saxpy(OpenAD_Symbol_250, __deriv__(PT), __deriv__(FVEC(K
     > )))
          CALL saxpy(OpenAD_Symbol_251, __deriv__(PT), __deriv__(FVEC(K
     > )))
          CALL saxpy(OpenAD_Symbol_252, __deriv__(PR), __deriv__(FVEC(K
     > )))
          CALL saxpy(OpenAD_Symbol_253, __deriv__(PR), __deriv__(FVEC(K
     > )))
          CALL saxpy(OpenAD_Symbol_254, __deriv__(P), __deriv__(FVEC(K)
     > ))
          CALL saxpy(OpenAD_Symbol_255, __deriv__(P), __deriv__(FVEC(K)
     > ))
          CALL saxpy(OpenAD_Symbol_256, __deriv__(PL), __deriv__(FVEC(K
     > )))
          CALL saxpy(OpenAD_Symbol_257, __deriv__(PL), __deriv__(FVEC(K
     > )))
          CALL saxpy(OpenAD_Symbol_258, __deriv__(PB), __deriv__(FVEC(K
     > )))
          CALL saxpy(OpenAD_Symbol_259, __deriv__(PB), __deriv__(FVEC(K
     > )))
        END DO
      END DO
      END SUBROUTINE
