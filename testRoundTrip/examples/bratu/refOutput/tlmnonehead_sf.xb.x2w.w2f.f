C ***********************************************************
C Fortran file translated from WHIRL Thu Oct  4 23:46:28 2007
C ***********************************************************
C ***********************************************************
...
C$OPENAD XXX Template ad_template.f
     ...
     >  OpenAD_Symbol_37)))
      ...
      CALL setderiv(__deriv__(OpenAD_Symbol_210), __deriv__(X(1)))
      CALL setderiv(__deriv__(OpenAD_Symbol_208), __deriv__(X(8)))
