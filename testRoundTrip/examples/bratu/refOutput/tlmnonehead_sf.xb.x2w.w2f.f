...
C$OPENAD XXX Template ad_template.f
     ...
     >  OpenAD_Symbol_37)))
      ...
      CALL setderiv(__deriv__(OpenAD_Symbol_212), __deriv__(X(1)))
      CALL setderiv(__deriv__(OpenAD_Symbol_210), __deriv__(X(8)))
      CALL setderiv(__deriv__(OpenAD_Symbol_208), __deriv__(X(1)))
      CALL setderiv(__deriv__(OpenAD_Symbol_206), __deriv__(X(8)))
      CALL setderiv(__deriv__(OpenAD_Symbol_203), __deriv__(X(9)))
      CALL setderiv(__deriv__(OpenAD_Symbol_201), __deriv__(X(1)))
      CALL setderiv(__deriv__(OpenAD_Symbol_198), __deriv__(X(9)))
      CALL setderiv(__deriv__(OpenAD_Symbol_196), __deriv__(X(1)))
      CALL setderiv(__deriv__(OpenAD_Symbol_191), __deriv__(X(1)))
      CALL setderiv(__deriv__(OpenAD_Symbol_187), __deriv__(X(1)))
      CALL sax(OpenAD_Symbol_186, __deriv__(OpenAD_Symbol_187),
     >  __deriv__(F(2)))
      CALL sax(OpenAD_Symbol_190, __deriv__(OpenAD_Symbol_191),
     >  __deriv__(F(1)))
      CALL saxpy(OpenAD_Symbol_195, __deriv__(OpenAD_Symbol_196),
     >  __deriv__(F(2)))
     ...
     >  __deriv__(F(1)))
      CALL saxpy(OpenAD_Symbol_205, __deriv__(OpenAD_Symbol_206),
     >  __deriv__(F(2)))
      CALL saxpy(OpenAD_Symbol_207, __deriv__(OpenAD_Symbol_208),
     >  __deriv__(F(1)))
      CALL saxpy(OpenAD_Symbol_209, __deriv__(OpenAD_Symbol_210),
     >  __deriv__(F(1)))
      CALL saxpy(OpenAD_Symbol_211, __deriv__(OpenAD_Symbol_212),
     >  __deriv__(F(2)))
      DO I = 2, 6, 1
     ...
     >  OpenAD_Symbol_61)))
        ...
        CALL setderiv(__deriv__(OpenAD_Symbol_230), __deriv__(X(8)))
        CALL setderiv(__deriv__(OpenAD_Symbol_228), __deriv__(X(9)))
        CALL setderiv(__deriv__(OpenAD_Symbol_226), __deriv__(X(I)))
        CALL setderiv(__deriv__(OpenAD_Symbol_221), __deriv__(X(I)))
        CALL setderiv(__deriv__(OpenAD_Symbol_218), __deriv__(F(I + (-1
     > ))))
        CALL setderiv(__deriv__(OpenAD_Symbol_216), __deriv__(X(I)))
        CALL sax(OpenAD_Symbol_215, __deriv__(OpenAD_Symbol_216),
     >  __deriv__(F(I + (-1))))
     ...
     >  __deriv__(F(I + (-1))))
        CALL saxpy(OpenAD_Symbol_227, __deriv__(OpenAD_Symbol_228),
     >  __deriv__(F(I + (-1))))
     ...
     >  OpenAD_Symbol_109)))
        ...
        CALL setderiv(__deriv__(OpenAD_Symbol_265), __deriv__(X(I)))
        CALL setderiv(__deriv__(OpenAD_Symbol_263), __deriv__(X(8)))
        CALL setderiv(__deriv__(OpenAD_Symbol_261), __deriv__(X(I)))
        CALL setderiv(__deriv__(OpenAD_Symbol_259), __deriv__(X(8)))
        CALL setderiv(__deriv__(OpenAD_Symbol_257), __deriv__(X(9)))
        CALL setderiv(__deriv__(OpenAD_Symbol_255), __deriv__(X(I)))
        CALL setderiv(__deriv__(OpenAD_Symbol_251), __deriv__(X(9)))
        CALL setderiv(__deriv__(OpenAD_Symbol_249), __deriv__(X(I)))
        CALL setderiv(__deriv__(OpenAD_Symbol_244), __deriv__(X(I)))
        CALL setderiv(__deriv__(OpenAD_Symbol_240), __deriv__(X(I)))
        CALL setderiv(__deriv__(OpenAD_Symbol_236), __deriv__(F(I)))
        CALL sax(OpenAD_Symbol_235, __deriv__(OpenAD_Symbol_236),
     >  __deriv__(F(I)))
        CALL sax(OpenAD_Symbol_239, __deriv__(OpenAD_Symbol_240),
     >  __deriv__(F(I + 1)))
        CALL saxpy(OpenAD_Symbol_243, __deriv__(OpenAD_Symbol_244),
     >  __deriv__(F(I)))
        CALL saxpy(OpenAD_Symbol_248, __deriv__(OpenAD_Symbol_249),
     >  __deriv__(F(I + 1)))
        CALL saxpy(OpenAD_Symbol_250, __deriv__(OpenAD_Symbol_251),
     >  __deriv__(F(I + 1)))
        CALL saxpy(OpenAD_Symbol_254, __deriv__(OpenAD_Symbol_255),
     >  __deriv__(F(I)))
        CALL saxpy(OpenAD_Symbol_256, __deriv__(OpenAD_Symbol_257),
     >  __deriv__(F(I)))
        CALL saxpy(OpenAD_Symbol_258, __deriv__(OpenAD_Symbol_259),
     >  __deriv__(F(I + 1)))
        CALL saxpy(OpenAD_Symbol_260, __deriv__(OpenAD_Symbol_261),
     >  __deriv__(F(I)))
        CALL saxpy(OpenAD_Symbol_262, __deriv__(OpenAD_Symbol_263),
     >  __deriv__(F(I)))
        CALL saxpy(OpenAD_Symbol_264, __deriv__(OpenAD_Symbol_265),
     >  __deriv__(F(I + 1)))
      END DO
     ...
     >  OpenAD_Symbol_133)))
      ...
      CALL setderiv(__deriv__(OpenAD_Symbol_283), __deriv__(X(8)))
      CALL setderiv(__deriv__(OpenAD_Symbol_281), __deriv__(X(9)))
      CALL setderiv(__deriv__(OpenAD_Symbol_279), __deriv__(X(7)))
      CALL setderiv(__deriv__(OpenAD_Symbol_274), __deriv__(X(7)))
      CALL setderiv(__deriv__(OpenAD_Symbol_271), __deriv__(F(6)))
      CALL setderiv(__deriv__(OpenAD_Symbol_269), __deriv__(X(7)))
      CALL sax(OpenAD_Symbol_268, __deriv__(OpenAD_Symbol_269),
     >  __deriv__(F(6)))
      CALL saxpy(OpenAD_Symbol_270, __deriv__(OpenAD_Symbol_271),
     >  __deriv__(F(6)))
      CALL saxpy(OpenAD_Symbol_273, __deriv__(OpenAD_Symbol_274),
     >  __deriv__(F(6)))
      CALL saxpy(OpenAD_Symbol_278, __deriv__(OpenAD_Symbol_279),
     >  __deriv__(F(6)))
      CALL saxpy(OpenAD_Symbol_280, __deriv__(OpenAD_Symbol_281),
     >  __deriv__(F(6)))
     ...
     >  __deriv__(F(6)))
      ...
      CALL setderiv(__deriv__(OpenAD_Symbol_287), __deriv__(F(7)))
      CALL setderiv(__deriv__(OpenAD_Symbol_285), __deriv__(X(7)))
      CALL sax(OpenAD_Symbol_284, __deriv__(OpenAD_Symbol_285),
     >  __deriv__(F(7)))
      CALL saxpy(OpenAD_Symbol_286, __deriv__(OpenAD_Symbol_287),
     >  __deriv__(F(7)))
     ...
     >  OpenAD_Symbol_171)))
      ...
      CALL setderiv(__deriv__(OpenAD_Symbol_305), __deriv__(F(7)))
      CALL setderiv(__deriv__(OpenAD_Symbol_303), __deriv__(X(8)))
      CALL setderiv(__deriv__(OpenAD_Symbol_300), __deriv__(X(9)))
      CALL setderiv(__deriv__(OpenAD_Symbol_298), __deriv__(X(7)))
      CALL setderiv(__deriv__(OpenAD_Symbol_294), __deriv__(X(7)))
      CALL sax(OpenAD_Symbol_293, __deriv__(OpenAD_Symbol_294),
     >  __deriv__(F(7)))
      CALL saxpy(OpenAD_Symbol_297, __deriv__(OpenAD_Symbol_298),
     >  __deriv__(F(7)))
      CALL saxpy(OpenAD_Symbol_299, __deriv__(OpenAD_Symbol_300),
     >  __deriv__(F(7)))
      CALL saxpy(OpenAD_Symbol_302, __deriv__(OpenAD_Symbol_303),
     >  __deriv__(F(7)))
      CALL saxpy(OpenAD_Symbol_304, __deriv__(OpenAD_Symbol_305),
     >  __deriv__(F(7)))
      RETURN
      END SUBROUTINE
