C ***********************************************************
C Fortran file translated from WHIRL Mon Jul 16 17:34:24 2007
C ***********************************************************
C ***********************************************************
...
C$OPENAD XXX Template ad_template.f
      ...
      OpenAD_Symbol_28 = (__value__(X(1)) *(-2.0D00) + OpenAD_Symbol_4
     >  * OpenAD_Symbol_5)
     ...
     >  OpenAD_Symbol_21)))
      ...
      OpenAD_Symbol_37 = (__value__(X(1)) * __value__(X(9)) + 1.0D00)
...
C     $OpenAD$ INLINE push(subst)
      ...
      DO I = 2, 6, 1
        OpenAD_Symbol_61 = (__value__(X(I)) * __value__(X(9)) + 1.0D00)
...
C       $OpenAD$ INLINE push_i(subst)
        CALL push_i(I)
        OpenAD_Symbol_312 = (I + INT((-1_w2f__i8)))
C       $OpenAD$ INLINE push_i(subst)
...
C       $OpenAD$ INLINE push_i(subst)
     ...
     >  OpenAD_Symbol_83)))
        ...
        OpenAD_Symbol_109 = (__value__(X(I)) * __value__(X(9)) + 1.0D00
     > )
...
C     $OpenAD$ INLINE push_i(subst)
      ...
      OpenAD_Symbol_133 = (__value__(X(7)) * __value__(X(9)) + 1.0D00)
...
C     $OpenAD$ INLINE push(subst)
      ...
      OpenAD_Symbol_151 = (__value__(F(7)) - __value__(X(7)) * 2.0D00)
...
C     $OpenAD$ INLINE push(subst)
      ...
      OpenAD_Symbol_171 = (__value__(X(7)) * __value__(X(9)) + 1.0D00)
...
C     $OpenAD$ INLINE Saxpy(subst,subst,subst)
      CALL Saxpy(OpenAD_Symbol_324, __deriv__(F(2)), __deriv__(
     > OpenAD_Symbol_212))
C     $OpenAD$ INLINE Pop(subst)
      CALL Pop(OpenAD_Symbol_325)
C     $OpenAD$ INLINE Saxpy(subst,subst,subst)
      CALL Saxpy(OpenAD_Symbol_325, __deriv__(F(1)), __deriv__(
     > OpenAD_Symbol_210))
C     $OpenAD$ INLINE Pop(subst)
      CALL Pop(OpenAD_Symbol_326)
C     $OpenAD$ INLINE Saxpy(subst,subst,subst)
      CALL Saxpy(OpenAD_Symbol_326, __deriv__(F(1)), __deriv__(
     > OpenAD_Symbol_208))
C     $OpenAD$ INLINE Pop(subst)
      CALL Pop(OpenAD_Symbol_327)
C     $OpenAD$ INLINE Saxpy(subst,subst,subst)
      CALL Saxpy(OpenAD_Symbol_327, __deriv__(F(2)), __deriv__(
     > OpenAD_Symbol_206))
C     $OpenAD$ INLINE Pop(subst)
      CALL Pop(OpenAD_Symbol_328)
C     $OpenAD$ INLINE Saxpy(subst,subst,subst)
      CALL Saxpy(OpenAD_Symbol_328, __deriv__(F(1)), __deriv__(
     > OpenAD_Symbol_203))
C     $OpenAD$ INLINE Pop(subst)
      CALL Pop(OpenAD_Symbol_329)
C     $OpenAD$ INLINE Saxpy(subst,subst,subst)
      CALL Saxpy(OpenAD_Symbol_329, __deriv__(F(1)), __deriv__(
     > OpenAD_Symbol_201))
C     $OpenAD$ INLINE Pop(subst)
      CALL Pop(OpenAD_Symbol_330)
C     $OpenAD$ INLINE Saxpy(subst,subst,subst)
      CALL Saxpy(OpenAD_Symbol_330, __deriv__(F(2)), __deriv__(
     > OpenAD_Symbol_198))
C     $OpenAD$ INLINE Pop(subst)
      CALL Pop(OpenAD_Symbol_331)
C     $OpenAD$ INLINE Saxpy(subst,subst,subst)
      CALL Saxpy(OpenAD_Symbol_331, __deriv__(F(2)), __deriv__(
     > OpenAD_Symbol_196))
C     $OpenAD$ INLINE Pop(subst)
      CALL Pop(OpenAD_Symbol_332)
C     $OpenAD$ INLINE Saxpy(subst,subst,subst)
      CALL Saxpy(OpenAD_Symbol_332, __deriv__(F(1)), __deriv__(
     > OpenAD_Symbol_191))
C     $OpenAD$ INLINE ZeroDeriv(subst)
...
C     $OpenAD$ INLINE Saxpy(subst,subst,subst)
      CALL Saxpy(OpenAD_Symbol_333, __deriv__(F(2)), __deriv__(
     > OpenAD_Symbol_187))
C     $OpenAD$ INLINE ZeroDeriv(subst)
...
C     $OpenAD$ INLINE IncDeriv(subst,subst)
      CALL IncDeriv(__deriv__(OpenAD_Symbol_208), __deriv__(X(8)))
C     $OpenAD$ INLINE ZeroDeriv(subst)
      CALL ZeroDeriv(__deriv__(OpenAD_Symbol_208))
C     $OpenAD$ INLINE IncDeriv(subst,subst)
      CALL IncDeriv(__deriv__(OpenAD_Symbol_210), __deriv__(X(1)))
C     $OpenAD$ INLINE ZeroDeriv(subst)
