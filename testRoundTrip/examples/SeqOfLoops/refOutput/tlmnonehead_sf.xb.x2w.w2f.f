...
C$OPENAD XXX Template ad_template.f
      ...
      DO I = 1, 2, 1
        ...
        CALL setderiv(__deriv__(OpenAD_Symbol_5), __deriv__(Y(I)))
        CALL sax(OpenAD_Symbol_3, __deriv__(X(I)), __deriv__(Y(I)))
        CALL saxpy(OpenAD_Symbol_4, __deriv__(OpenAD_Symbol_5),
     >  __deriv__(Y(I)))
      END DO
      END SUBROUTINE
