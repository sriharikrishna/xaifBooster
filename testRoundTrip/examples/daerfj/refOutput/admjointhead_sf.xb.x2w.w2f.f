C ***********************************************************
C Fortran file translated from WHIRL Mon Jan 15 14:37:42 2007
C ***********************************************************
C ***********************************************************
...
C       $OpenAD$ INLINE Saxpy(subst,subst,subst)
        CALL Saxpy(OpenAD_Symbol_43, __deriv__(FVEC(INT(
     > OpenAD_Symbol_42))), __deriv__(OpenAD_Symbol_35))
C       $OpenAD$ INLINE pop_i(subst)
        CALL pop_i(OpenAD_Symbol_44)
C       $OpenAD$ INLINE Pop(subst)
        CALL Pop(OpenAD_Symbol_45)
C       $OpenAD$ INLINE Saxpy(subst,subst,subst)
        CALL Saxpy(OpenAD_Symbol_45, __deriv__(FVEC(INT(
     > OpenAD_Symbol_44))), __deriv__(OpenAD_Symbol_33))
C       $OpenAD$ INLINE pop_i(subst)
        CALL pop_i(OpenAD_Symbol_46)
C       $OpenAD$ INLINE Pop(subst)
        CALL Pop(OpenAD_Symbol_47)
C       $OpenAD$ INLINE Saxpy(subst,subst,subst)
        CALL Saxpy(OpenAD_Symbol_47, __deriv__(FVEC(INT(
     > OpenAD_Symbol_46))), __deriv__(OpenAD_Symbol_28))
C       $OpenAD$ INLINE pop_i(subst)
        CALL pop_i(OpenAD_Symbol_48)
C       $OpenAD$ INLINE Pop(subst)
        CALL Pop(OpenAD_Symbol_49)
C       $OpenAD$ INLINE Saxpy(subst,subst,subst)
        CALL Saxpy(OpenAD_Symbol_49, __deriv__(FVEC(INT(
     > OpenAD_Symbol_48))), __deriv__(OpenAD_Symbol_25))
C       $OpenAD$ INLINE ZeroDeriv(subst)
        CALL ZeroDeriv(__deriv__(FVEC(INT(OpenAD_Symbol_48))))
