...
C$OPENAD XXX Template ad_template.f
      IF(__value__(X(1)) .LE. __value__(X(2))) THEN
        IF(__value__(X(1)) .eq. __value__(X(2))) THEN
          ...
          CALL saxpy(OpenAD_Symbol_7, __deriv__(X(1)), __deriv__(Y(1)))
        ELSE
          ...
          CALL sax(OpenAD_Symbol_9, __deriv__(X(2)), __deriv__(Y(1)))
     ...
     > )
      ...
      ELSE
        ...
        CALL sax(OpenAD_Symbol_11, __deriv__(X(1)), __deriv__(Y(1)))
        CALL saxpy(OpenAD_Symbol_12, __deriv__(X(2)), __deriv__(Y(1)))
      ENDIF
