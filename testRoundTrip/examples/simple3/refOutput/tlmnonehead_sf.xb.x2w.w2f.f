...
C$OPENAD XXX Template ad_template.f
     ...
     >  OpenAD_Symbol_5)
      ...
      CALL saxpy(OpenAD_Symbol_12, __deriv__(X1), __deriv__(Y1))
      CALL sax(OpenAD_Symbol_13, __deriv__(X1), __deriv__(Y2))
      CALL saxpy(OpenAD_Symbol_16, __deriv__(X1), __deriv__(Y1))
      CALL saxpy(OpenAD_Symbol_17, __deriv__(X1), __deriv__(Y2))
      CALL saxpy(OpenAD_Symbol_18, __deriv__(X2), __deriv__(Y1))
      CALL saxpy(OpenAD_Symbol_19, __deriv__(X2), __deriv__(Y2))
      END SUBROUTINE
