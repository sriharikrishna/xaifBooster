C ***********************************************************
C Fortran file translated from WHIRL Fri Nov 10 15:51:08 2006
C ***********************************************************
C ***********************************************************
...
C     $OpenAD$ INLINE cp_res_store_real_scalar(subst)
      CALL cp_res_store_real_scalar(BARX)
C     $OpenAD$ INLINE cp_res_store_real_scalar(subst)
      CALL cp_res_store_real_scalar(BARY)
C     $OpenAD$ END REPLACEMENT
...
C     $OpenAD$ INLINE cp_res_restore_real_scalar(subst)
      CALL cp_res_restore_real_scalar(BARX)
C     $OpenAD$ INLINE cp_res_restore_real_scalar(subst)
...
C     $OpenAD$ BEGIN REPLACEMENT 3
C     $OpenAD$ INLINE convert_a2p_scalar(subst,subst)
      CALL convert_a2p_scalar(OpenAD_Symbol_5, __deriv__(GX))
C     $OpenAD$ INLINE convert_a2p_scalar(subst,subst)
      CALL convert_a2p_scalar(OpenAD_Symbol_6, __deriv__(GY))
      CALL bar(OpenAD_Symbol_5, OpenAD_Symbol_6)
C     $OpenAD$ INLINE convert_p2a_scalar(subst,subst)
      CALL convert_p2a_scalar(__deriv__(GX), OpenAD_Symbol_5)
C     $OpenAD$ INLINE convert_p2a_scalar(subst,subst)
      CALL convert_p2a_scalar(__deriv__(GY), OpenAD_Symbol_6)
C     $OpenAD$ END REPLACEMENT
C     $OpenAD$ BEGIN REPLACEMENT 4
...
C     $OpenAD$ INLINE cp_res_store_real_scalar_a(subst)
      CALL cp_res_store_real_scalar_a(__deriv__(GX))
C     $OpenAD$ INLINE cp_res_store_real_scalar_a(subst)
      CALL cp_res_store_real_scalar_a(__deriv__(GY))
C     $OpenAD$ END REPLACEMENT
C     $OpenAD$ BEGIN REPLACEMENT 6
...
C     $OpenAD$ INLINE cp_res_restore_real_scalar_a(subst)
      CALL cp_res_restore_real_scalar_a(__deriv__(GX))
C     $OpenAD$ INLINE cp_res_restore_real_scalar_a(subst)
...
C     $OpenAD$ INLINE Saxpy(subst,subst,subst)
      CALL Saxpy(OpenAD_Symbol_7, __deriv__(GY), __deriv__(
     > OpenAD_Symbol_2))
