...
C     $OpenAD$ INLINE cp_tsarg_store_real_scalar_a(subst)
      CALL cp_tsarg_store_real_scalar_a(__deriv__(UVEL))
C     $OpenAD$ INLINE cp_tsarg_store_real_vector_a(subst)
      CALL cp_tsarg_store_real_vector_a(__deriv__(RHO))
C     $OpenAD$ INLINE cp_tsarg_store_real_vector_a(subst)
      CALL cp_tsarg_store_real_vector_a(__deriv__(SNEW))
C     $OpenAD$ INLINE cp_tsarg_store_real_vector_a(subst)
      CALL cp_tsarg_store_real_vector_a(__deriv__(SNOW))
C     $OpenAD$ INLINE cp_tsarg_store_real_vector_a(subst)
      CALL cp_tsarg_store_real_vector_a(__deriv__(SOLD))
C     $OpenAD$ INLINE cp_tsarg_store_real_vector_a(subst)
      CALL cp_tsarg_store_real_vector_a(__deriv__(TNEW))
C     $OpenAD$ INLINE cp_tsarg_store_real_vector_a(subst)
      CALL cp_tsarg_store_real_vector_a(__deriv__(TNOW))
C     $OpenAD$ INLINE cp_tsarg_store_real_vector_a(subst)
      CALL cp_tsarg_store_real_vector_a(__deriv__(TOLD))
C     $OpenAD$ INLINE cp_arg_store_integer_scalar(subst)
      CALL cp_arg_store_integer_scalar(ILEV1)
C     $OpenAD$ INLINE cp_arg_store_real_scalar(subst)
      CALL cp_arg_store_real_scalar(GAMMA_S)
...
C     $OpenAD$ INLINE cp_tsarg_restore_real_vector(subst)
      CALL cp_tsarg_restore_real_vector(TSTAR)
C     $OpenAD$ INLINE cp_tsarg_restore_real_vector_a(subst)
      CALL cp_tsarg_restore_real_vector_a(__deriv__(TOLD))
C     $OpenAD$ INLINE cp_tsarg_restore_real_vector_a(subst)
      CALL cp_tsarg_restore_real_vector_a(__deriv__(TNOW))
C     $OpenAD$ INLINE cp_tsarg_restore_real_vector_a(subst)
      CALL cp_tsarg_restore_real_vector_a(__deriv__(TNEW))
C     $OpenAD$ INLINE cp_tsarg_restore_real_vector(subst)
      CALL cp_tsarg_restore_real_vector(SSTAR)
C     $OpenAD$ INLINE cp_tsarg_restore_real_vector_a(subst)
      CALL cp_tsarg_restore_real_vector_a(__deriv__(SOLD))
C     $OpenAD$ INLINE cp_tsarg_restore_real_vector_a(subst)
      CALL cp_tsarg_restore_real_vector_a(__deriv__(SNOW))
C     $OpenAD$ INLINE cp_tsarg_restore_real_vector_a(subst)
      CALL cp_tsarg_restore_real_vector_a(__deriv__(SNEW))
C     $OpenAD$ INLINE cp_tsarg_restore_real_vector_a(subst)
      CALL cp_tsarg_restore_real_vector_a(__deriv__(RHO))
C     $OpenAD$ INLINE cp_tsarg_restore_real_vector(subst)
      CALL cp_tsarg_restore_real_vector(NULLFORCE)
C     $OpenAD$ INLINE cp_tsarg_restore_real_vector(subst)
      CALL cp_tsarg_restore_real_vector(FW)
C     $OpenAD$ INLINE cp_tsarg_restore_real_scalar_a(subst)
      CALL cp_tsarg_restore_real_scalar_a(__deriv__(UVEL))
C     $OpenAD$ INLINE cp_tsarg_restore_real_scalar(subst)
      CALL cp_tsarg_restore_real_scalar(GAMMA_T)
C     $OpenAD$ INLINE cp_tsarg_restore_real_scalar(subst)
      CALL cp_tsarg_restore_real_scalar(GAMMA_S)
C     $OpenAD$ INLINE cp_tsarg_restore_integer_scalar(subst)
      CALL cp_tsarg_restore_integer_scalar(ILEV1)
C     $OpenAD$ INLINE cp_arg_restore_real_vector_a(subst)
      CALL cp_arg_restore_real_vector_a(__deriv__(TOLD))
C     $OpenAD$ INLINE cp_arg_restore_real_vector_a(subst)
      CALL cp_arg_restore_real_vector_a(__deriv__(TNOW))
...
C     $OpenAD$ END REPLACEMENT
C     $OpenAD$ BEGIN REPLACEMENT 8
C     $OpenAD$ INLINE cp_tsarg_store_real_vector(subst)
      CALL cp_tsarg_store_real_vector(TSVEC)
C     $OpenAD$ INLINE cp_arg_store_real_vector_a(subst)
      CALL cp_arg_store_real_vector_a(__deriv__(SNOW))
C     $OpenAD$ INLINE cp_arg_store_real_vector_a(subst)
      CALL cp_arg_store_real_vector_a(__deriv__(TNOW))
...
C     $OpenAD$ INLINE cp_tsarg_store_real_scalar(subst)
      CALL cp_tsarg_store_real_scalar(METRIC)
C     $OpenAD$ INLINE cp_tsarg_store_real_scalar(subst)
      CALL cp_tsarg_store_real_scalar(METRIC1)
C     $OpenAD$ INLINE cp_tsarg_store_real_scalar(subst)
      CALL cp_tsarg_store_real_scalar(METRIC2)
C     $OpenAD$ INLINE cp_tsarg_store_real_scalar(subst)
      CALL cp_tsarg_store_real_scalar(THC_S)
C     $OpenAD$ INLINE cp_tsarg_store_real_scalar(subst)
      CALL cp_tsarg_store_real_scalar(THC_T)
C     $OpenAD$ INLINE cp_tsarg_store_real_scalar(subst)
      CALL cp_tsarg_store_real_scalar(THC_TOT)
C     $OpenAD$ INLINE cp_tsarg_store_real_scalar(subst)
      CALL cp_tsarg_store_real_scalar(UBAR)
C     $OpenAD$ INLINE cp_tsarg_store_real_scalar_a(subst)
      CALL cp_tsarg_store_real_scalar_a(__deriv__(UVEL))
C     $OpenAD$ INLINE cp_tsarg_store_real_vector(subst)
      CALL cp_tsarg_store_real_vector(FW)
C     $OpenAD$ INLINE cp_tsarg_store_real_vector(subst)
      CALL cp_tsarg_store_real_vector(NULLFORCE)
C     $OpenAD$ INLINE cp_tsarg_store_real_vector_a(subst)
      CALL cp_tsarg_store_real_vector_a(__deriv__(S))
C     $OpenAD$ INLINE cp_tsarg_store_real_vector_a(subst)
      CALL cp_tsarg_store_real_vector_a(__deriv__(SNEW))
C     $OpenAD$ INLINE cp_tsarg_store_real_vector_a(subst)
      CALL cp_tsarg_store_real_vector_a(__deriv__(SNOW))
C     $OpenAD$ INLINE cp_tsarg_store_real_vector_a(subst)
      CALL cp_tsarg_store_real_vector_a(__deriv__(SOLD))
C     $OpenAD$ INLINE cp_tsarg_store_real_vector(subst)
      CALL cp_tsarg_store_real_vector(SSTAR)
C     $OpenAD$ INLINE cp_tsarg_store_real_vector_a(subst)
      CALL cp_tsarg_store_real_vector_a(__deriv__(T))
C     $OpenAD$ INLINE cp_tsarg_store_real_vector_a(subst)
      CALL cp_tsarg_store_real_vector_a(__deriv__(TNEW))
C     $OpenAD$ INLINE cp_tsarg_store_real_vector_a(subst)
      CALL cp_tsarg_store_real_vector_a(__deriv__(TNOW))
C     $OpenAD$ INLINE cp_tsarg_store_real_vector_a(subst)
      CALL cp_tsarg_store_real_vector_a(__deriv__(TOLD))
C     $OpenAD$ INLINE cp_tsarg_store_real_vector(subst)
      CALL cp_tsarg_store_real_vector(TSTAR)
C     $OpenAD$ INLINE cp_tsarg_store_real_vector(subst)
      CALL cp_tsarg_store_real_vector(TSVEC)
C     $OpenAD$ INLINE cp_arg_store_real_scalar(subst)
      CALL cp_arg_store_real_scalar(HUNDRED)
...
C     $OpenAD$ BEGIN REPLACEMENT 9
C     $OpenAD$ INLINE cp_tsarg_restore_real_vector_a(subst)
      CALL cp_tsarg_restore_real_vector_a(__deriv__(XX))
C     $OpenAD$ INLINE cp_tsarg_restore_real_vector_a(subst)
      CALL cp_tsarg_restore_real_vector_a(__deriv__(T))
C     $OpenAD$ INLINE cp_tsarg_restore_real_vector_a(subst)
      CALL cp_tsarg_restore_real_vector_a(__deriv__(S))
C     $OpenAD$ INLINE cp_tsarg_restore_real_vector(subst)
      CALL cp_tsarg_restore_real_vector(FW)
C     $OpenAD$ INLINE cp_tsarg_restore_real_vector(subst)
      CALL cp_tsarg_restore_real_vector(AREA)
C     $OpenAD$ INLINE cp_tsarg_restore_real_scalar(subst)
      CALL cp_tsarg_restore_real_scalar(YEAR)
C     $OpenAD$ INLINE cp_tsarg_restore_real_scalar(subst)
      CALL cp_tsarg_restore_real_scalar(SV)
C     $OpenAD$ INLINE cp_tsarg_restore_real_scalar(subst)
      CALL cp_tsarg_restore_real_scalar(HUNDRED)
C     $OpenAD$ INLINE cp_arg_restore_real_vector(subst)
      CALL cp_arg_restore_real_vector(TSVEC)
C     $OpenAD$ INLINE cp_arg_restore_real_vector(subst)
      CALL cp_arg_restore_real_vector(TSTAR)
...
C     $OpenAD$ BEGIN REPLACEMENT 8
C     $OpenAD$ INLINE cp_tsarg_store_real_scalar(subst)
      CALL cp_tsarg_store_real_scalar(ALPHA)
C     $OpenAD$ INLINE cp_tsarg_store_real_scalar(subst)
      CALL cp_tsarg_store_real_scalar(BETA)
C     $OpenAD$ INLINE cp_tsarg_store_real_scalar(subst)
      CALL cp_tsarg_store_real_scalar(BWIDTH)
C     $OpenAD$ INLINE cp_tsarg_store_real_scalar(subst)
      CALL cp_tsarg_store_real_scalar(DAY)
C     $OpenAD$ INLINE cp_tsarg_store_real_scalar(subst)
      CALL cp_tsarg_store_real_scalar(DAYS_PER_50M_MIXED_LAYER)
C     $OpenAD$ INLINE cp_tsarg_store_real_scalar(subst)
      CALL cp_tsarg_store_real_scalar(DELTA)
C     $OpenAD$ INLINE cp_tsarg_store_real_scalar(subst)
      CALL cp_tsarg_store_real_scalar(DELTA_T)
C     $OpenAD$ INLINE cp_tsarg_store_real_scalar(subst)
      CALL cp_tsarg_store_real_scalar(EPSILON_IC)
C     $OpenAD$ INLINE cp_tsarg_store_real_scalar(subst)
      CALL cp_tsarg_store_real_scalar(EPSILON_REGULARIZE)
C     $OpenAD$ INLINE cp_tsarg_store_real_scalar(subst)
      CALL cp_tsarg_store_real_scalar(FDEPS)
C     $OpenAD$ INLINE cp_tsarg_store_real_scalar(subst)
      CALL cp_tsarg_store_real_scalar(GAMMA_S)
C     $OpenAD$ INLINE cp_tsarg_store_real_scalar(subst)
      CALL cp_tsarg_store_real_scalar(GAMMA_T)
C     $OpenAD$ INLINE cp_tsarg_store_real_scalar(subst)
      CALL cp_tsarg_store_real_scalar(HUNDRED)
C     $OpenAD$ INLINE cp_tsarg_store_real_scalar(subst)
      CALL cp_tsarg_store_real_scalar(INTEGRATION_TIME)
C     $OpenAD$ INLINE cp_tsarg_store_real_scalar(subst)
      CALL cp_tsarg_store_real_scalar(NOISE_CORRELATION_TIME)
C     $OpenAD$ INLINE cp_tsarg_store_integer_scalar(subst)
      CALL cp_tsarg_store_integer_scalar(N_MAX)
C     $OpenAD$ INLINE cp_tsarg_store_real_scalar(subst)
      CALL cp_tsarg_store_real_scalar(ROBERT_FILTER_COEFF)
C     $OpenAD$ INLINE cp_tsarg_store_real_scalar(subst)
      CALL cp_tsarg_store_real_scalar(SV)
C     $OpenAD$ INLINE cp_tsarg_store_real_scalar(subst)
      CALL cp_tsarg_store_real_scalar(THOUSAND)
C     $OpenAD$ INLINE cp_tsarg_store_real_scalar(subst)
      CALL cp_tsarg_store_real_scalar(U0)
C     $OpenAD$ INLINE cp_tsarg_store_bool_scalar(subst)
      CALL cp_tsarg_store_bool_scalar(VERBMODE)
C     $OpenAD$ INLINE cp_tsarg_store_real_scalar(subst)
      CALL cp_tsarg_store_real_scalar(YEAR)
C     $OpenAD$ INLINE cp_tsarg_store_real_vector(subst)
      CALL cp_tsarg_store_real_vector(AREA)
C     $OpenAD$ INLINE cp_tsarg_store_real_vector(subst)
      CALL cp_tsarg_store_real_vector(BHEIGHT)
C     $OpenAD$ INLINE cp_tsarg_store_real_vector(subst)
      CALL cp_tsarg_store_real_vector(BLENGTH)
C     $OpenAD$ INLINE cp_tsarg_store_real_vector(subst)
      CALL cp_tsarg_store_real_vector(PROJ_S)
C     $OpenAD$ INLINE cp_tsarg_store_real_vector(subst)
      CALL cp_tsarg_store_real_vector(PROJ_T)
C     $OpenAD$ INLINE cp_tsarg_store_real_vector(subst)
      CALL cp_tsarg_store_real_vector(R)
C     $OpenAD$ INLINE cp_tsarg_store_real_vector(subst)
      CALL cp_tsarg_store_real_vector(R1)
C     $OpenAD$ INLINE cp_tsarg_store_real_vector(subst)
      CALL cp_tsarg_store_real_vector(R_S)
C     $OpenAD$ INLINE cp_tsarg_store_real_vector(subst)
      CALL cp_tsarg_store_real_vector(R_T)
C     $OpenAD$ INLINE cp_tsarg_store_real_vector(subst)
      CALL cp_tsarg_store_real_vector(VOL)
C     $OpenAD$ INLINE cp_tsarg_store_real_matrix(subst)
      CALL cp_tsarg_store_real_matrix(X)
C     $OpenAD$ INLINE cp_tsarg_store_real_vector(subst)
      CALL cp_tsarg_store_real_vector(Y)
C     $OpenAD$ INLINE cp_arg_store_real_vector(subst)
      CALL cp_arg_store_real_vector(AREA)
C     $OpenAD$ INLINE cp_arg_store_real_vector(subst)
      CALL cp_arg_store_real_vector(BHEIGHT)
...
C     $OpenAD$ END REPLACEMENT
C     $OpenAD$ BEGIN REPLACEMENT 9
C     $OpenAD$ INLINE cp_tsarg_restore_real_matrix(subst)
      CALL cp_tsarg_restore_real_matrix(X)
C     $OpenAD$ INLINE cp_tsarg_restore_real_vector(subst)
      CALL cp_tsarg_restore_real_vector(R)
C     $OpenAD$ INLINE cp_tsarg_restore_real_vector(subst)
      CALL cp_tsarg_restore_real_vector(PROJ_T)
C     $OpenAD$ INLINE cp_tsarg_restore_real_vector(subst)
      CALL cp_tsarg_restore_real_vector(PROJ_S)
C     $OpenAD$ INLINE cp_tsarg_restore_real_vector(subst)
      CALL cp_tsarg_restore_real_vector(BLENGTH)
C     $OpenAD$ INLINE cp_tsarg_restore_real_vector(subst)
      CALL cp_tsarg_restore_real_vector(BHEIGHT)
C     $OpenAD$ INLINE cp_tsarg_restore_real_vector(subst)
      CALL cp_tsarg_restore_real_vector(AREA)
C     $OpenAD$ INLINE cp_arg_restore_real_vector(subst)
...
C     $OpenAD$ BEGIN REPLACEMENT 9
C     $OpenAD$ INLINE cp_tsarg_restore_integer_scalar(subst)
      CALL cp_tsarg_restore_integer_scalar(N_MAX)
C     $OpenAD$ INLINE cp_arg_restore_real_vector(subst)
      CALL cp_arg_restore_real_vector(TSVEC)
C     $OpenAD$ INLINE cp_arg_restore_real_vector(subst)
      CALL cp_arg_restore_real_vector(TSTAR)
...
C     $OpenAD$ BEGIN REPLACEMENT 8
C     $OpenAD$ INLINE cp_tsarg_store_real_vector_a(subst)
      CALL cp_tsarg_store_real_vector_a(__deriv__(RHOLOC))
C     $OpenAD$ INLINE cp_arg_store_real_scalar(subst)
      CALL cp_arg_store_real_scalar(ALPHA)
C     $OpenAD$ INLINE cp_arg_store_real_scalar(subst)
      CALL cp_arg_store_real_scalar(BETA)
...
C     $OpenAD$ BEGIN REPLACEMENT 9
C     $OpenAD$ INLINE cp_tsarg_restore_real_vector_a(subst)
      CALL cp_tsarg_restore_real_vector_a(__deriv__(SLOC))
C     $OpenAD$ INLINE cp_tsarg_restore_real_vector_a(subst)
      CALL cp_tsarg_restore_real_vector_a(__deriv__(TLOC))
C     $OpenAD$ INLINE cp_tsarg_restore_real_scalar(subst)
      CALL cp_tsarg_restore_real_scalar(BETA)
C     $OpenAD$ INLINE cp_tsarg_restore_real_scalar(subst)
      CALL cp_tsarg_restore_real_scalar(ALPHA)
C     $OpenAD$ INLINE cp_arg_restore_real_vector_a(subst)
...
C     $OpenAD$ BEGIN REPLACEMENT 8
C     $OpenAD$ INLINE cp_tsarg_store_real_scalar_a(subst)
      CALL cp_tsarg_store_real_scalar_a(__deriv__(UVELLOC))
C     $OpenAD$ INLINE cp_arg_store_real_scalar(subst)
      CALL cp_arg_store_real_scalar(DELTA)
C     $OpenAD$ INLINE cp_arg_store_real_scalar(subst)
      CALL cp_arg_store_real_scalar(U0)
...
C     $OpenAD$ BEGIN REPLACEMENT 9
C     $OpenAD$ INLINE cp_tsarg_restore_real_vector_a(subst)
      CALL cp_tsarg_restore_real_vector_a(__deriv__(RHOLOC))
C     $OpenAD$ INLINE cp_tsarg_restore_real_scalar(subst)
      CALL cp_tsarg_restore_real_scalar(U0)
C     $OpenAD$ INLINE cp_tsarg_restore_real_scalar(subst)
      CALL cp_tsarg_restore_real_scalar(DELTA)
C     $OpenAD$ INLINE cp_arg_restore_real_scalar_a(subst)
...
C     $OpenAD$ BEGIN REPLACEMENT 8
C     $OpenAD$ INLINE cp_tsarg_store_real_vector_a(subst)
      CALL cp_tsarg_store_real_vector_a(__deriv__(FLDNOW))
C     $OpenAD$ INLINE cp_arg_store_real_scalar(subst)
      CALL cp_arg_store_real_scalar(ROBERT_FILTER_COEFF)
C     $OpenAD$ INLINE cp_arg_store_real_vector_a(subst)
      CALL cp_arg_store_real_vector_a(__deriv__(FLDNOW))
...
C     $OpenAD$ BEGIN REPLACEMENT 9
C     $OpenAD$ INLINE cp_tsarg_restore_real_vector_a(subst)
      CALL cp_tsarg_restore_real_vector_a(__deriv__(FLDNEW))
C     $OpenAD$ INLINE cp_tsarg_restore_real_vector_a(subst)
      CALL cp_tsarg_restore_real_vector_a(__deriv__(FLDOLD))
C     $OpenAD$ INLINE cp_tsarg_restore_real_vector_a(subst)
      CALL cp_tsarg_restore_real_vector_a(__deriv__(FLDNOW))
C     $OpenAD$ INLINE cp_tsarg_restore_real_scalar(subst)
      CALL cp_tsarg_restore_real_scalar(ROBERT_FILTER_COEFF)
C     $OpenAD$ INLINE cp_arg_restore_real_vector_a(subst)
      CALL cp_arg_restore_real_vector_a(__deriv__(FLDNOW))
C     $OpenAD$ END REPLACEMENT
      END SUBROUTINE
...
C     $OpenAD$ BEGIN REPLACEMENT 8
C     $OpenAD$ INLINE cp_tsarg_store_real_vector_a(subst)
      CALL cp_tsarg_store_real_vector_a(__deriv__(FLDNEW))
C     $OpenAD$ INLINE cp_arg_store_real_scalar(subst)
      CALL cp_arg_store_real_scalar(DELTA_T)
C     $OpenAD$ INLINE cp_arg_store_real_vector_a(subst)
      CALL cp_arg_store_real_vector_a(__deriv__(FLDOLD))
...
C     $OpenAD$ BEGIN REPLACEMENT 9
C     $OpenAD$ INLINE cp_tsarg_restore_real_vector_a(subst)
      CALL cp_tsarg_restore_real_vector_a(__deriv__(DFLDDT))
C     $OpenAD$ INLINE cp_tsarg_restore_real_vector_a(subst)
      CALL cp_tsarg_restore_real_vector_a(__deriv__(FLDOLD))
C     $OpenAD$ INLINE cp_tsarg_restore_real_scalar(subst)
      CALL cp_tsarg_restore_real_scalar(DELTA_T)
C     $OpenAD$ INLINE cp_arg_restore_real_vector_a(subst)
      CALL cp_arg_restore_real_vector_a(__deriv__(FLDNEW))
C     $OpenAD$ END REPLACEMENT
      END SUBROUTINE
...
C     $OpenAD$ BEGIN REPLACEMENT 9
C     $OpenAD$ INLINE cp_tsarg_restore_real_vector(subst)
      CALL cp_tsarg_restore_real_vector(VOL)
C     $OpenAD$ INLINE cp_tsarg_restore_real_vector_a(subst)
      CALL cp_tsarg_restore_real_vector_a(__deriv__(FLDNEW))
C     $OpenAD$ INLINE cp_tsarg_restore_real_vector_a(subst)
      CALL cp_tsarg_restore_real_vector_a(__deriv__(FLDOLD))
C     $OpenAD$ INLINE cp_tsarg_restore_real_vector_a(subst)
      CALL cp_tsarg_restore_real_vector_a(__deriv__(FLDNOW))
C     $OpenAD$ INLINE cp_tsarg_restore_real_vector(subst)
      CALL cp_tsarg_restore_real_vector(EXTFORLOC)
C     $OpenAD$ INLINE cp_tsarg_restore_real_vector(subst)
      CALL cp_tsarg_restore_real_vector(FLDSTAR)
C     $OpenAD$ INLINE cp_tsarg_restore_real_scalar_a(subst)
      CALL cp_tsarg_restore_real_scalar_a(__deriv__(UVELLOC))
C     $OpenAD$ INLINE cp_tsarg_restore_real_scalar(subst)
      CALL cp_tsarg_restore_real_scalar(GAMMALOC)
C     $OpenAD$ INLINE cp_arg_restore_real_vector_a(subst)
      CALL cp_arg_restore_real_vector_a(__deriv__(FLDNEW))
C     $OpenAD$ END REPLACEMENT
      END SUBROUTINE
