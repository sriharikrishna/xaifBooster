...
cun parameter ( 3 = 3 )
      ...
      double precision blength(3)
      double precision bheight(3)
     ...
     & blength, bheight, bwidth, area, vol
      ...
      double precision y(2*3)
      double precision r(2*3)
      double precision r1(2*3)
      double precision r_t(2*3)
      double precision r_s(2*3)
      double precision proj_t(2*3)
      double precision proj_s(2*3)
      double precision x(2*3,2*3)
      common / pa_algebra_r /
...
cun parameter ( 8 = 8 )
     ...
     & rho
      ...
      double precision nullForce(3 -1)
      double precision fw(3 -1)
      double precision tStar(3 -1)
      double precision sStar(3 -1)
      common / fi_forcing_params_r /
     & nullForce, fw, tStar, sStar

      double precision ubar, t(3), s(3)
      common /fi_ini_r /
     & ubar
     & , t
     & , s
...
c-- dependent and independent variables
      ...
      double precision xx(2*3)
      common /fi_controls_r / xx

      double precision tsvec(2*3)
...
c-- routine body
            ...
            ikey = ilev1
CADJ STORE tnow = comlev1, key = ikey, byte = 8
CADJ STORE snow = comlev1, key = ikey, byte = 8
...
CADJ STORE uvel = comlev1, key = ikey, byte = 8
...
CADJ INIT comlev1 = COMMON, 73
        do ilev1 = 1, 73
         iloop = ( ilev2 - 1 )*73 + ilev1
...
c -- routine arguments:
      double precision tLoc(3)
      double precision sLoc(3)
      double precision rhoLoc(3)
