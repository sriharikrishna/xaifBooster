C ***********************************************************
C Fortran file translated from WHIRL Fri Jul 21 11:34:17 2006
C ***********************************************************
C ***********************************************************
...
C     $OpenAD$ INLINE cp_tsarg_store_real_scalar(subst)
      CALL cp_tsarg_store_real_scalar(Y)
C     $OpenAD$ INLINE cp_arg_store_real_scalar(subst)
      CALL cp_arg_store_real_scalar(Y)
C     $OpenAD$ INLINE cp_arg_store_real_vector(subst)
      CALL cp_arg_store_real_vector(X)
...
C     $OpenAD$ INLINE cp_tsarg_restore_real_vector(subst)
      CALL cp_tsarg_restore_real_vector(X)
C     $OpenAD$ INLINE cp_tsarg_restore_real_scalar(subst)
      CALL cp_tsarg_restore_real_scalar(Y)
C     $OpenAD$ INLINE cp_arg_restore_real_scalar(subst)
      CALL cp_arg_restore_real_scalar(Y)
C     $OpenAD$ END REPLACEMENT
      END SUBROUTINE
