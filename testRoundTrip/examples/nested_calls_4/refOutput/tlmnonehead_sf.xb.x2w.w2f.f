...
C     $OpenAD$ INLINE convert_a2p_scalar(subst,subst)
      ...
      CALL sax(OpenAD_Symbol_13, __deriv__(C), __deriv__(Y(3)))
      CALL saxpy(OpenAD_Symbol_14, __deriv__(D), __deriv__(Y(3)))
      CALL sax(OpenAD_Symbol_15, __deriv__(C), __deriv__(Y(4)))
      CALL saxpy(OpenAD_Symbol_16, __deriv__(D), __deriv__(Y(4)))
      END SUBROUTINE
...
C$OPENAD XXX Template ad_template.f
      ...
      CALL sax(OpenAD_Symbol_17, __deriv__(A), __deriv__(C))
      CALL saxpy(OpenAD_Symbol_18, __deriv__(B), __deriv__(C))
      CALL sax(OpenAD_Symbol_19, __deriv__(A), __deriv__(D))
      CALL saxpy(OpenAD_Symbol_20, __deriv__(B), __deriv__(D))
      END SUBROUTINE
