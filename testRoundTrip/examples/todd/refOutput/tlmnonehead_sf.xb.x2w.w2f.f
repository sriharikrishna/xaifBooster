C ***********************************************************
C Fortran file translated from WHIRL Thu Jul 20 16:24:41 2006
C ***********************************************************
C ***********************************************************
...
C$OPENAD XXX Template ad_template.f
     ...
     >  __deriv__(MATR(2)))
      ...
      CALL setderiv(__deriv__(OpenAD_Symbol_118), __deriv__(MATR(3)))
      CALL setderiv(__deriv__(OpenAD_Symbol_116), __deriv__(MATR(0)))
      CALL setderiv(__deriv__(OpenAD_Symbol_114), __deriv__(MATR(2)))
      CALL setderiv(__deriv__(OpenAD_Symbol_112), __deriv__(MATR(1)))
      CALL setderiv(__deriv__(OpenAD_Symbol_106), __deriv__(MATR(0)))
      CALL setderiv(__deriv__(OpenAD_Symbol_104), __deriv__(MATR(0)))
      CALL setderiv(__deriv__(OpenAD_Symbol_102), __deriv__(MATR(1)))
      CALL setderiv(__deriv__(OpenAD_Symbol_100), __deriv__(MATR(1)))
      CALL setderiv(__deriv__(OpenAD_Symbol_98), __deriv__(MATR(2)))
      CALL setderiv(__deriv__(OpenAD_Symbol_96), __deriv__(MATR(2)))
      CALL setderiv(__deriv__(OpenAD_Symbol_94), __deriv__(MATR(3)))
      CALL setderiv(__deriv__(OpenAD_Symbol_92), __deriv__(MATR(3)))
      CALL sax(OpenAD_Symbol_91, __deriv__(OpenAD_Symbol_92), __deriv__
     > (OBJ(1)))
      CALL saxpy(OpenAD_Symbol_93, __deriv__(OpenAD_Symbol_94),
     >  __deriv__(OBJ(1)))
      CALL saxpy(OpenAD_Symbol_95, __deriv__(OpenAD_Symbol_96),
     >  __deriv__(OBJ(1)))
      CALL saxpy(OpenAD_Symbol_97, __deriv__(OpenAD_Symbol_98),
     >  __deriv__(OBJ(1)))
      CALL saxpy(OpenAD_Symbol_99, __deriv__(OpenAD_Symbol_100),
     >  __deriv__(OBJ(1)))
      CALL saxpy(OpenAD_Symbol_101, __deriv__(OpenAD_Symbol_102),
     >  __deriv__(OBJ(1)))
      CALL saxpy(OpenAD_Symbol_103, __deriv__(OpenAD_Symbol_104),
     >  __deriv__(OBJ(1)))
      CALL saxpy(OpenAD_Symbol_105, __deriv__(OpenAD_Symbol_106),
     >  __deriv__(OBJ(1)))
      CALL saxpy(OpenAD_Symbol_111, __deriv__(OpenAD_Symbol_112),
     >  __deriv__(OBJ(1)))
