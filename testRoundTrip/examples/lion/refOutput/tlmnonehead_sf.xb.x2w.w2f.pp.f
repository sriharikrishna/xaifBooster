...
C$OPENAD XXX Template ad_template.f
     ...
     >  OpenAD_Symbol_10)
      ...
      CALL sax(OpenAD_Symbol_18,X(1),Y(4))
      CALL sax(OpenAD_Symbol_19,X(1),Y(3))
      CALL sax(OpenAD_Symbol_20,X(1),Y(2))
      CALL sax(OpenAD_Symbol_21,X(1),Y(1))
      CALL saxpy(OpenAD_Symbol_22,X(2),Y(4))
      CALL saxpy(OpenAD_Symbol_23,X(2),Y(3))
      CALL saxpy(OpenAD_Symbol_24,X(2),Y(2))
