...
C$OPENAD XXX Template ad_template.f
     ...
     >  __value__(X(2)))))
      ...
      OpenAD_Symbol_14 = (OpenAD_Symbol_9 + OpenAD_Symbol_2 *
     >  OpenAD_Symbol_10)
      ...
      CALL sax(OpenAD_Symbol_18, __deriv__(X(1)), __deriv__(Y(4)))
      CALL sax(OpenAD_Symbol_19, __deriv__(X(1)), __deriv__(Y(3)))
      CALL sax(OpenAD_Symbol_20, __deriv__(X(1)), __deriv__(Y(2)))
      CALL sax(OpenAD_Symbol_21, __deriv__(X(1)), __deriv__(Y(1)))
      CALL saxpy(OpenAD_Symbol_22, __deriv__(X(2)), __deriv__(Y(4)))
      CALL saxpy(OpenAD_Symbol_23, __deriv__(X(2)), __deriv__(Y(3)))
      CALL saxpy(OpenAD_Symbol_24, __deriv__(X(2)), __deriv__(Y(2)))
