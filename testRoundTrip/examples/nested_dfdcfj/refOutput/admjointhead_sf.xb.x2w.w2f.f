C ***********************************************************
C Fortran file translated from WHIRL Fri Jul 21 11:35:19 2006
C ***********************************************************
C ***********************************************************
...
C       $OpenAD$ INLINE Saxpy(subst,subst,subst)
     ...
     > OpenAD_Symbol_311))), __deriv__(OpenAD_Symbol_170))
C       $OpenAD$ INLINE ZeroDeriv(subst)
        CALL ZeroDeriv(__deriv__(FVEC(INT(OpenAD_Symbol_311))))
C       $OpenAD$ INLINE pop_i(subst)
...
C           $OpenAD$ INLINE push_i(subst)
          ...
          ELSE
            __value__(PBL) = __value__(X(K - NX + (-1)))
            OpenAD_Symbol_420 = (K - NX + INT((-1_w2f__i8)))
C           $OpenAD$ INLINE push_i(subst)
...
C             $OpenAD$ INLINE push_i(subst)
            ...
            ELSE
              __value__(PB) = __value__(X(K - NX))
              __value__(PBB) = __value__(X(K - NX * 2))
              OpenAD_Symbol_416 = (K - NX * INT(2_w2f__i8))
C             $OpenAD$ INLINE push_i(subst)
              CALL push_i(OpenAD_Symbol_416)
              OpenAD_Symbol_417 = (K - NX)
C             $OpenAD$ INLINE push_i(subst)
...
C           $OpenAD$ INLINE push_i(subst)
          ...
          ELSE
            __value__(PBR) = __value__(X(K - NX + 1))
            OpenAD_Symbol_412 = (K - NX + INT(1_w2f__i8))
C           $OpenAD$ INLINE push_i(subst)
...
C             $OpenAD$ INLINE push_i(subst)
            ...
            ELSE
              __value__(PR) = __value__(X(K + 1))
              __value__(PRR) = __value__(X(K + 2))
              OpenAD_Symbol_402 = (K + INT(2_w2f__i8))
C             $OpenAD$ INLINE push_i(subst)
              CALL push_i(OpenAD_Symbol_402)
              OpenAD_Symbol_403 = (K + INT(1_w2f__i8))
C             $OpenAD$ INLINE push_i(subst)
...
C           $OpenAD$ INLINE push_i(subst)
          ...
          ELSE
            __value__(PTL) = __value__(X(NX + K + (-1)))
            OpenAD_Symbol_399 = (NX + K + INT((-1_w2f__i8)))
C           $OpenAD$ INLINE push_i(subst)
...
C             $OpenAD$ INLINE push_i(subst)
            ...
            ELSE
              __value__(PT) = __value__(X(NX + K))
              __value__(PTT) = __value__(X(K + NX * 2))
              OpenAD_Symbol_395 = (K + NX * INT(2_w2f__i8))
C             $OpenAD$ INLINE push_i(subst)
              CALL push_i(OpenAD_Symbol_395)
              OpenAD_Symbol_396 = (NX + K)
C             $OpenAD$ INLINE push_i(subst)
...
C           $OpenAD$ INLINE push_i(subst)
          ...
          ELSE
            __value__(PTR) = __value__(X(NX + K + 1))
            OpenAD_Symbol_391 = (NX + K + INT(1_w2f__i8))
C           $OpenAD$ INLINE push_i(subst)
...
C         $OpenAD$ INLINE Saxpy(subst,subst,subst)
     ...
     > OpenAD_Symbol_363))), __deriv__(OpenAD_Symbol_216))
C         $OpenAD$ INLINE pop_i(subst)
...
C         $OpenAD$ INLINE Saxpy(subst,subst,subst)
     ...
     > OpenAD_Symbol_365))), __deriv__(OpenAD_Symbol_216))
C         $OpenAD$ INLINE pop_i(subst)
...
C         $OpenAD$ INLINE Saxpy(subst,subst,subst)
     ...
     > OpenAD_Symbol_367))), __deriv__(OpenAD_Symbol_191))
C         $OpenAD$ INLINE pop_i(subst)
...
C         $OpenAD$ INLINE Saxpy(subst,subst,subst)
     ...
     > OpenAD_Symbol_369))), __deriv__(OpenAD_Symbol_194))
C         $OpenAD$ INLINE pop_i(subst)
...
C         $OpenAD$ INLINE Saxpy(subst,subst,subst)
     ...
     > OpenAD_Symbol_371))), __deriv__(OpenAD_Symbol_211))
C         $OpenAD$ INLINE pop_i(subst)
...
C         $OpenAD$ INLINE Saxpy(subst,subst,subst)
     ...
     > OpenAD_Symbol_373))), __deriv__(OpenAD_Symbol_198))
C         $OpenAD$ INLINE pop_i(subst)
...
C         $OpenAD$ INLINE Saxpy(subst,subst,subst)
     ...
     > OpenAD_Symbol_375))), __deriv__(OpenAD_Symbol_201))
C         $OpenAD$ INLINE pop_i(subst)
...
C         $OpenAD$ INLINE Saxpy(subst,subst,subst)
     ...
     > OpenAD_Symbol_377))), __deriv__(OpenAD_Symbol_205))
C         $OpenAD$ INLINE pop_i(subst)
...
C         $OpenAD$ INLINE Saxpy(subst,subst,subst)
     ...
     > OpenAD_Symbol_379))), __deriv__(OpenAD_Symbol_201))
C         $OpenAD$ INLINE pop_i(subst)
...
C         $OpenAD$ INLINE Saxpy(subst,subst,subst)
     ...
     > OpenAD_Symbol_381))), __deriv__(OpenAD_Symbol_198))
C         $OpenAD$ INLINE pop_i(subst)
...
C         $OpenAD$ INLINE Saxpy(subst,subst,subst)
     ...
     > OpenAD_Symbol_383))), __deriv__(OpenAD_Symbol_194))
C         $OpenAD$ INLINE pop_i(subst)
...
C         $OpenAD$ INLINE Saxpy(subst,subst,subst)
     ...
     > OpenAD_Symbol_385))), __deriv__(OpenAD_Symbol_191))
C         $OpenAD$ INLINE ZeroDeriv(subst)
          CALL ZeroDeriv(__deriv__(FVEC(INT(OpenAD_Symbol_385))))
C         $OpenAD$ INLINE IncDeriv(subst,subst)
...
C         $OpenAD$ INLINE Saxpy(subst,subst,subst)
          CALL Saxpy(OpenAD_Symbol_387, __deriv__(DPDX), __deriv__(
     > OpenAD_Symbol_183))
C         $OpenAD$ INLINE Pop(subst)
          CALL Pop(OpenAD_Symbol_388)
C         $OpenAD$ INLINE Saxpy(subst,subst,subst)
          CALL Saxpy(OpenAD_Symbol_388, __deriv__(DPDX), __deriv__(
     > OpenAD_Symbol_181))
C         $OpenAD$ INLINE ZeroDeriv(subst)
...
C         $OpenAD$ INLINE Saxpy(subst,subst,subst)
          CALL Saxpy(OpenAD_Symbol_389, __deriv__(DPDY), __deriv__(
     > OpenAD_Symbol_179))
C         $OpenAD$ INLINE Pop(subst)
          CALL Pop(OpenAD_Symbol_390)
C         $OpenAD$ INLINE Saxpy(subst,subst,subst)
          CALL Saxpy(OpenAD_Symbol_390, __deriv__(DPDY), __deriv__(
     > OpenAD_Symbol_177))
C         $OpenAD$ INLINE ZeroDeriv(subst)
...
C             $OpenAD$ INLINE Saxpy(subst,subst,subst)
              CALL Saxpy(OpenAD_Symbol_393, __deriv__(PTT), __deriv__(
     > OpenAD_Symbol_220))
C             $OpenAD$ INLINE ZeroDeriv(subst)
              CALL ZeroDeriv(__deriv__(PTT))
C             $OpenAD$ INLINE ZeroDeriv(subst)
...
C     $OpenAD$ INLINE cp_tsarg_restore_real_vector_a(subst)
      CALL cp_tsarg_restore_real_vector_a(__deriv__(X))
C     $OpenAD$ INLINE cp_tsarg_restore_real_scalar(subst)
      CALL cp_tsarg_restore_real_scalar(HX2)
C     $OpenAD$ INLINE cp_tsarg_restore_real_scalar(subst)
      CALL cp_tsarg_restore_real_scalar(HY2)
C     $OpenAD$ INLINE cp_tsarg_restore_real_scalar(subst)
      CALL cp_tsarg_restore_real_scalar(HY)
C     $OpenAD$ INLINE cp_tsarg_restore_real_scalar(subst)
      CALL cp_tsarg_restore_real_scalar(HX)
C     $OpenAD$ INLINE cp_tsarg_restore_real_scalar(subst)
      CALL cp_tsarg_restore_real_scalar(R)
C     $OpenAD$ INLINE cp_tsarg_restore_integer_scalar(subst)
      CALL cp_tsarg_restore_integer_scalar(NY)
...
C     $OpenAD$ INLINE Saxpy(subst,subst,subst)
      CALL Saxpy(OpenAD_Symbol_422, __deriv__(PBLAP), __deriv__(
     > OpenAD_Symbol_270))
C     $OpenAD$ INLINE Pop(subst)
      CALL Pop(OpenAD_Symbol_423)
C     $OpenAD$ INLINE Saxpy(subst,subst,subst)
      CALL Saxpy(OpenAD_Symbol_423, __deriv__(PBLAP), __deriv__(
     > OpenAD_Symbol_270))
C     $OpenAD$ INLINE Pop(subst)
      CALL Pop(OpenAD_Symbol_424)
C     $OpenAD$ INLINE Saxpy(subst,subst,subst)
      CALL Saxpy(OpenAD_Symbol_424, __deriv__(PLLAP), __deriv__(
     > OpenAD_Symbol_263))
C     $OpenAD$ INLINE Pop(subst)
      CALL Pop(OpenAD_Symbol_425)
C     $OpenAD$ INLINE Saxpy(subst,subst,subst)
      CALL Saxpy(OpenAD_Symbol_425, __deriv__(PLLAP), __deriv__(
     > OpenAD_Symbol_263))
C     $OpenAD$ INLINE Pop(subst)
      CALL Pop(OpenAD_Symbol_426)
C     $OpenAD$ INLINE Saxpy(subst,subst,subst)
      CALL Saxpy(OpenAD_Symbol_426, __deriv__(PLAP), __deriv__(
     > OpenAD_Symbol_244))
C     $OpenAD$ INLINE Pop(subst)
      CALL Pop(OpenAD_Symbol_427)
C     $OpenAD$ INLINE Saxpy(subst,subst,subst)
      CALL Saxpy(OpenAD_Symbol_427, __deriv__(PLAP), __deriv__(
     > OpenAD_Symbol_244))
C     $OpenAD$ INLINE Pop(subst)
      CALL Pop(OpenAD_Symbol_428)
C     $OpenAD$ INLINE Saxpy(subst,subst,subst)
      CALL Saxpy(OpenAD_Symbol_428, __deriv__(PRLAP), __deriv__(
     > OpenAD_Symbol_266))
C     $OpenAD$ INLINE Pop(subst)
      CALL Pop(OpenAD_Symbol_429)
C     $OpenAD$ INLINE Saxpy(subst,subst,subst)
      CALL Saxpy(OpenAD_Symbol_429, __deriv__(PRLAP), __deriv__(
     > OpenAD_Symbol_266))
C     $OpenAD$ INLINE Pop(subst)
      CALL Pop(OpenAD_Symbol_430)
C     $OpenAD$ INLINE Saxpy(subst,subst,subst)
      CALL Saxpy(OpenAD_Symbol_430, __deriv__(PTLAP), __deriv__(
     > OpenAD_Symbol_273))
C     $OpenAD$ INLINE Pop(subst)
      CALL Pop(OpenAD_Symbol_431)
C     $OpenAD$ INLINE Saxpy(subst,subst,subst)
      CALL Saxpy(OpenAD_Symbol_431, __deriv__(PTLAP), __deriv__(
     > OpenAD_Symbol_273))
C     $OpenAD$ INLINE Pop(subst)
      CALL Pop(OpenAD_Symbol_432)
C     $OpenAD$ INLINE Saxpy(subst,subst,subst)
      CALL Saxpy(OpenAD_Symbol_432, __deriv__(PBLAP), __deriv__(
     > OpenAD_Symbol_244))
C     $OpenAD$ INLINE Pop(subst)
      CALL Pop(OpenAD_Symbol_433)
C     $OpenAD$ INLINE Saxpy(subst,subst,subst)
      CALL Saxpy(OpenAD_Symbol_433, __deriv__(PBLAP), __deriv__(
     > OpenAD_Symbol_294))
C     $OpenAD$ INLINE Pop(subst)
      CALL Pop(OpenAD_Symbol_434)
C     $OpenAD$ INLINE Saxpy(subst,subst,subst)
      CALL Saxpy(OpenAD_Symbol_434, __deriv__(PBLAP), __deriv__(
     > OpenAD_Symbol_257))
C     $OpenAD$ INLINE Pop(subst)
      CALL Pop(OpenAD_Symbol_435)
C     $OpenAD$ INLINE Saxpy(subst,subst,subst)
      CALL Saxpy(OpenAD_Symbol_435, __deriv__(PBLAP), __deriv__(
     > OpenAD_Symbol_283))
C     $OpenAD$ INLINE ZeroDeriv(subst)
...
C     $OpenAD$ INLINE Saxpy(subst,subst,subst)
      CALL Saxpy(OpenAD_Symbol_436, __deriv__(PLLAP), __deriv__(
     > OpenAD_Symbol_237))
C     $OpenAD$ INLINE Pop(subst)
      CALL Pop(OpenAD_Symbol_437)
C     $OpenAD$ INLINE Saxpy(subst,subst,subst)
      CALL Saxpy(OpenAD_Symbol_437, __deriv__(PLLAP), __deriv__(
     > OpenAD_Symbol_283))
C     $OpenAD$ INLINE Pop(subst)
      CALL Pop(OpenAD_Symbol_438)
C     $OpenAD$ INLINE Saxpy(subst,subst,subst)
      CALL Saxpy(OpenAD_Symbol_438, __deriv__(PLLAP), __deriv__(
     > OpenAD_Symbol_244))
C     $OpenAD$ INLINE Pop(subst)
      CALL Pop(OpenAD_Symbol_439)
C     $OpenAD$ INLINE Saxpy(subst,subst,subst)
      CALL Saxpy(OpenAD_Symbol_439, __deriv__(PLLAP), __deriv__(
     > OpenAD_Symbol_277))
C     $OpenAD$ INLINE ZeroDeriv(subst)
...
C     $OpenAD$ INLINE Saxpy(subst,subst,subst)
      CALL Saxpy(OpenAD_Symbol_440, __deriv__(PLAP), __deriv__(
     > OpenAD_Symbol_273))
C     $OpenAD$ INLINE Pop(subst)
      CALL Pop(OpenAD_Symbol_441)
C     $OpenAD$ INLINE Saxpy(subst,subst,subst)
      CALL Saxpy(OpenAD_Symbol_441, __deriv__(PLAP), __deriv__(
     > OpenAD_Symbol_270))
C     $OpenAD$ INLINE Pop(subst)
      CALL Pop(OpenAD_Symbol_442)
C     $OpenAD$ INLINE Saxpy(subst,subst,subst)
      CALL Saxpy(OpenAD_Symbol_442, __deriv__(PLAP), __deriv__(
     > OpenAD_Symbol_266))
C     $OpenAD$ INLINE Pop(subst)
      CALL Pop(OpenAD_Symbol_443)
C     $OpenAD$ INLINE Saxpy(subst,subst,subst)
      CALL Saxpy(OpenAD_Symbol_443, __deriv__(PLAP), __deriv__(
     > OpenAD_Symbol_263))
C     $OpenAD$ INLINE ZeroDeriv(subst)
...
C     $OpenAD$ INLINE Saxpy(subst,subst,subst)
      CALL Saxpy(OpenAD_Symbol_444, __deriv__(PRLAP), __deriv__(
     > OpenAD_Symbol_240))
C     $OpenAD$ INLINE Pop(subst)
      CALL Pop(OpenAD_Symbol_445)
C     $OpenAD$ INLINE Saxpy(subst,subst,subst)
      CALL Saxpy(OpenAD_Symbol_445, __deriv__(PRLAP), __deriv__(
     > OpenAD_Symbol_257))
C     $OpenAD$ INLINE Pop(subst)
      CALL Pop(OpenAD_Symbol_446)
C     $OpenAD$ INLINE Saxpy(subst,subst,subst)
      CALL Saxpy(OpenAD_Symbol_446, __deriv__(PRLAP), __deriv__(
     > OpenAD_Symbol_253))
C     $OpenAD$ INLINE Pop(subst)
      CALL Pop(OpenAD_Symbol_447)
C     $OpenAD$ INLINE Saxpy(subst,subst,subst)
      CALL Saxpy(OpenAD_Symbol_447, __deriv__(PRLAP), __deriv__(
     > OpenAD_Symbol_244))
C     $OpenAD$ INLINE ZeroDeriv(subst)
...
C     $OpenAD$ INLINE Saxpy(subst,subst,subst)
      CALL Saxpy(OpenAD_Symbol_448, __deriv__(PTLAP), __deriv__(
     > OpenAD_Symbol_247))
C     $OpenAD$ INLINE Pop(subst)
      CALL Pop(OpenAD_Symbol_449)
C     $OpenAD$ INLINE Saxpy(subst,subst,subst)
      CALL Saxpy(OpenAD_Symbol_449, __deriv__(PTLAP), __deriv__(
     > OpenAD_Symbol_244))
C     $OpenAD$ INLINE Pop(subst)
      CALL Pop(OpenAD_Symbol_450)
C     $OpenAD$ INLINE Saxpy(subst,subst,subst)
      CALL Saxpy(OpenAD_Symbol_450, __deriv__(PTLAP), __deriv__(
     > OpenAD_Symbol_240))
C     $OpenAD$ INLINE Pop(subst)
      CALL Pop(OpenAD_Symbol_451)
C     $OpenAD$ INLINE Saxpy(subst,subst,subst)
      CALL Saxpy(OpenAD_Symbol_451, __deriv__(PTLAP), __deriv__(
     > OpenAD_Symbol_237))
C     $OpenAD$ INLINE ZeroDeriv(subst)
...
C     $OpenAD$ INLINE cp_res_store_real_scalar_a(subst)
      CALL cp_res_store_real_scalar_a(__deriv__(PLAP))
C     $OpenAD$ INLINE cp_res_store_real_scalar_a(subst)
      CALL cp_res_store_real_scalar_a(__deriv__(PBLAP))
C     $OpenAD$ INLINE cp_res_store_real_scalar_a(subst)
      CALL cp_res_store_real_scalar_a(__deriv__(PLLAP))
C     $OpenAD$ INLINE cp_res_store_real_scalar_a(subst)
      CALL cp_res_store_real_scalar_a(__deriv__(PRLAP))
C     $OpenAD$ INLINE cp_res_store_real_scalar_a(subst)
      CALL cp_res_store_real_scalar_a(__deriv__(PTLAP))
C     $OpenAD$ END REPLACEMENT
C     $OpenAD$ BEGIN REPLACEMENT 6
C     $OpenAD$ INLINE cp_arg_restore_real_scalar(subst)
      CALL cp_arg_restore_real_scalar(HX2)
...
C     $OpenAD$ INLINE cp_res_restore_real_scalar_a(subst)
      CALL cp_res_restore_real_scalar_a(__deriv__(PLAP))
C     $OpenAD$ INLINE cp_res_restore_real_scalar_a(subst)
      CALL cp_res_restore_real_scalar_a(__deriv__(PBLAP))
C     $OpenAD$ INLINE cp_res_restore_real_scalar_a(subst)
      CALL cp_res_restore_real_scalar_a(__deriv__(PLLAP))
C     $OpenAD$ INLINE cp_res_restore_real_scalar_a(subst)
      CALL cp_res_restore_real_scalar_a(__deriv__(PRLAP))
C     $OpenAD$ INLINE cp_res_restore_real_scalar_a(subst)
      CALL cp_res_restore_real_scalar_a(__deriv__(PTLAP))
C     $OpenAD$ END REPLACEMENT
C     $OpenAD$ BEGIN REPLACEMENT 8
C     $OpenAD$ INLINE cp_tsarg_store_real_scalar_a(subst)
      CALL cp_tsarg_store_real_scalar_a(__deriv__(PLAP))
C     $OpenAD$ INLINE cp_tsarg_store_real_scalar_a(subst)
      CALL cp_tsarg_store_real_scalar_a(__deriv__(PBLAP))
C     $OpenAD$ INLINE cp_tsarg_store_real_scalar_a(subst)
      CALL cp_tsarg_store_real_scalar_a(__deriv__(PLLAP))
C     $OpenAD$ INLINE cp_tsarg_store_real_scalar_a(subst)
      CALL cp_tsarg_store_real_scalar_a(__deriv__(PRLAP))
C     $OpenAD$ INLINE cp_tsarg_store_real_scalar_a(subst)
      CALL cp_tsarg_store_real_scalar_a(__deriv__(PTLAP))
C     $OpenAD$ INLINE cp_arg_store_real_scalar_a(subst)
      CALL cp_arg_store_real_scalar_a(__deriv__(PBB))
C     $OpenAD$ INLINE cp_arg_store_real_scalar_a(subst)
      CALL cp_arg_store_real_scalar_a(__deriv__(PBL))
...
C     $OpenAD$ INLINE cp_tsarg_restore_real_scalar_a(subst)
      CALL cp_tsarg_restore_real_scalar_a(__deriv__(PTT))
C     $OpenAD$ INLINE cp_tsarg_restore_real_scalar_a(subst)
      CALL cp_tsarg_restore_real_scalar_a(__deriv__(PTR))
C     $OpenAD$ INLINE cp_tsarg_restore_real_scalar_a(subst)
      CALL cp_tsarg_restore_real_scalar_a(__deriv__(PT))
C     $OpenAD$ INLINE cp_tsarg_restore_real_scalar_a(subst)
      CALL cp_tsarg_restore_real_scalar_a(__deriv__(PTL))
C     $OpenAD$ INLINE cp_tsarg_restore_real_scalar_a(subst)
      CALL cp_tsarg_restore_real_scalar_a(__deriv__(PRR))
C     $OpenAD$ INLINE cp_tsarg_restore_real_scalar_a(subst)
      CALL cp_tsarg_restore_real_scalar_a(__deriv__(PR))
C     $OpenAD$ INLINE cp_tsarg_restore_real_scalar_a(subst)
      CALL cp_tsarg_restore_real_scalar_a(__deriv__(P))
C     $OpenAD$ INLINE cp_tsarg_restore_real_scalar_a(subst)
      CALL cp_tsarg_restore_real_scalar_a(__deriv__(PL))
C     $OpenAD$ INLINE cp_tsarg_restore_real_scalar_a(subst)
      CALL cp_tsarg_restore_real_scalar_a(__deriv__(PLL))
C     $OpenAD$ INLINE cp_tsarg_restore_real_scalar_a(subst)
      CALL cp_tsarg_restore_real_scalar_a(__deriv__(PBR))
C     $OpenAD$ INLINE cp_tsarg_restore_real_scalar_a(subst)
      CALL cp_tsarg_restore_real_scalar_a(__deriv__(PB))
C     $OpenAD$ INLINE cp_tsarg_restore_real_scalar_a(subst)
      CALL cp_tsarg_restore_real_scalar_a(__deriv__(PBL))
C     $OpenAD$ INLINE cp_tsarg_restore_real_scalar_a(subst)
      CALL cp_tsarg_restore_real_scalar_a(__deriv__(PBB))
C     $OpenAD$ INLINE cp_arg_restore_real_scalar_a(subst)
