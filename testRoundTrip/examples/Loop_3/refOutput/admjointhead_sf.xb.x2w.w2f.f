...
C           $OpenAD$ INLINE Saxpy(subst,subst,subst)
            CALL Saxpy(OpenAD_Symbol_35, __deriv__(Y(INT(
     > OpenAD_Symbol_34))), __deriv__(OpenAD_Symbol_3))
C           $OpenAD$ INLINE pop_i(subst)
...
C           $OpenAD$ INLINE Saxpy(subst,subst,subst)
            CALL Saxpy(OpenAD_Symbol_38, __deriv__(Y(INT(
     > OpenAD_Symbol_36))), __deriv__(X(INT(OpenAD_Symbol_37))))
...
C         $OpenAD$ INLINE IncDeriv(subst,subst)
          CALL IncDeriv(__deriv__(Y(INT(OpenAD_Symbol_32))), __deriv__(
     > X(INT(OpenAD_Symbol_33))))
C         $OpenAD$ INLINE ZeroDeriv(subst)
