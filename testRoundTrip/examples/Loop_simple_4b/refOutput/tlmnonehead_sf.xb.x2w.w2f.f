...
C$OPENAD XXX Simple loop
     ...
     >  __value__(X(I)))
        ...
        CALL setderiv(__deriv__(OpenAD_Symbol_7), __deriv__(Y(J)))
        CALL sax(OpenAD_Symbol_4, __deriv__(X(I)), __deriv__(Y(J)))
        CALL saxpy(OpenAD_Symbol_5, __deriv__(X(I)), __deriv__(Y(J)))
