...
C$OPENAD XXX Template ad_template.f
      ...
      CALL setderiv(__deriv__(OpenAD_Symbol_22), __deriv__(X2))
     ...
     >  __deriv__(Y1))
      CALL saxpy(OpenAD_Symbol_20, __deriv__(OpenAD_Symbol_17),
     >  __deriv__(Y2))
      CALL saxpy(OpenAD_Symbol_21, __deriv__(OpenAD_Symbol_22),
     >  __deriv__(Y1))
      CALL saxpy(OpenAD_Symbol_23, __deriv__(OpenAD_Symbol_22),
     >  __deriv__(Y2))
      CALL saxpy(OpenAD_Symbol_24, __deriv__(OpenAD_Symbol_22),
     >  __deriv__(Y2))
      END SUBROUTINE
