...
C$OPENAD XXX Template ad_template.f
      ...
      CALL sax(OpenAD_Symbol_8, __deriv__(X(1)), __deriv__(T2))
      CALL foo()
     ...
     > )
      ...
      CALL sax(OpenAD_Symbol_9, __deriv__(T2), __deriv__(Y))
      CALL saxpy(OpenAD_Symbol_10, __deriv__(T), __deriv__(Y))
      END SUBROUTINE
